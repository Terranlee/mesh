...
// Operators
    ...
    Vec3f Vec3f::cross(const Vec3f& v2)
    {
        return Vec3f(this->y*v2.z-this->z*v2.y, this->z*v2.x-this->x*v2.z, this->x*v2.y-this->y*v2.x);
    }

    float Vec3f::product(const Vec3f& v2)
    {
